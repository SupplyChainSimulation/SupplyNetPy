...
from SupplyNetPy.Components import inventory_old
...
class Link:
    ...
    """
    def __init__(self, from_node, to_node, lead_time, transportation_cost,
                 transportation_type="road", iso_log=False,**kwargs):
...
class Retailer(Node):
    ...
    def __init__(self, env, name, node_id, location, products,
        ...
        self.inventory = inventory_old.Inventory(env, capacity=inv_capacity, holding_cost=inv_holding_cost,
...
class Distributor(Node):
    ...
    def __init__(self, env, name, node_id, location, products,
        ...
        self.supplier_list = []
        self.reorder_level = reorder_level
        self.inventory = inventory_old.Inventory(env, capacity=inv_capacity, holding_cost=inv_holding_cost, reorder_level = self.reorder_level,
